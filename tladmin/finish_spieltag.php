  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href="finish_spieltag.php"><span class="glyphicon glyphicon-file"></span> <span>Spieltag abschließen</span></a></li>
        </ul><!-- /.sidebar-menu -->
      </section>
      <!-- /.sidebar -->
    </aside>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <!-- LIGA SPIELTAG ABSCHLIEßEN -->       
        <form class="form-horizontal" id="spieltagEndForm">
        <h3>Liga Spieltag abschließen</h3>
          <div class="row">
            <form action="include/angular/finish_spieltag.php" method="post">
              <div class="form-group col-lg-4 col-xs-12">
                <div class="col-lg-4">
                  <button type="button" class="btn btn-success" name="endGamedaySubmit" id="endGamedayData">abschließen</button>
                </div>    
              </div>
            </form>
          </div>         
        ...
        <!-- LIGA SPIELTAG ABSCHLIEßEN -->       
        <form class="form-horizontal" id="spieltagEndForm">
        <h3>Pokal Spieltag abschließen</h3>
          <div class="row">
            <form action="include/angular/finish_pokal_spieltag.php" method="post">
              <div class="form-group col-lg-4 col-xs-12">
                <div class="col-lg-4">
                  <button type="button" class="btn btn-success" name="endPokalGamedaySubmit" id="endPokalGamedayData">abschließen</button>
                </div>    
              </div>
            </form>
          </div>         
