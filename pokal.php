...
<html lang="de" ng-app="tl" ng-controller="pokalCtrl">
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Tippliga24 - Pokal</title>
...
<?php include_once('include/content/pokal_content.php');?>
<?php include_once('views/footer.php');?>

<?php include_once('views/profil.php'); ?>
<?php include_once('views/teams_modal.php');?>
